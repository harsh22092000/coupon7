...
$usr=$_POST["email"];
$pas=$_POST["pass"];
$sql = "select count(*) from tbl_Shop where email ='$usr' and pass='$pas'";
$result = $conn->query($sql);
    $rows=$result->fetch_assoc();

if ($rows["count(*)"]> 0) {

$sql = "select * from tbl_Shop where email ='$usr' and pass='$pas'";
$result = $conn->query($sql);
$rows=$result->fetch_assoc();

$_SESSION["fName"]=$rows["fName"];
$_SESSION["lName"]=$rows["lName"];
$_SESSION["cId"]=$rows["shopId"];
$_SESSION["sId"]=$rows["shopId"];
$_SESSION["role"]='S';
...
echo $_SESSION["lName"];
    ...
    header("location:shopKeeperDashBoard.php");
   ...
   <body style="background-color: #dee9ff;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                   <center><h1>Shopkeeper Login </h1></center>
